                ...
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group expertModeVisible">
                                <label class="col-md-2 control-label">{{Clef nodeJS}}</label>
                                <div class="col-md-2"> 
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Langue}}</label>
                                <div class="col-md-2">
            ...
            <div id="config_memcache" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Durée de vie memcache (secondes)}}</label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Vider toutes les données en cache}}</label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Cron persistance du cache}}</label>
                                <div class="col-md-3">
            ...
            <div id="config_history" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Période de calcul pour min, max, moyenne (en heure)}}</label>
                                <div class="col-md-3">
                                    <input type="text"  class="configKey form-control" data-l1key="historyCalculPeriod" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Période de calcul pour la tendance (en heure)}}</label>
                                <div class="col-md-3">
                                    <input type="text"  class="configKey form-control" data-l1key="historyCalculTendance" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Délai avant archivage (heure)}}</label>
                                <div class="col-md-3">
                                    <input type="text"  class="configKey form-control" data-l1key="historyArchiveTime" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Archiver par paquet de (heure)}}</label>
                                <div class="col-md-3">
                                    <input type="text"  class="configKey form-control" data-l1key="historyArchivePackage" />
                                </div>
                            </div>
                            <div class="form-group alert alert-danger">
                                <label class="col-md-2 control-label">{{Seuil de calcul de tendance}}</label>
            ...
            <div id="configuration_cron" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Rattrapage maximum autorisé (min, -1 pour infini)}}</label>
                                <div class="col-md-3">
                                    <input type="text" class="configKey form-control" data-l1key="maxCatchAllow"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Crontask : temps exécution max (min)}}</label>
                                <div class="col-md-3">
                                    <input type="text" class="configKey form-control" data-l1key="maxExecTimeCrontask"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Script : temps exécution max (min)}}</label>
                                <div class="col-md-3">
                                    <input type="text" class="configKey form-control" data-l1key="maxExecTimeScript"/>
                                </div>
                            </div>
                            <div class="form-group alert alert-danger">
                                <label class="col-md-2 control-label">{{Jeecron sleep time}}</label>
                                <div class="col-md-3">
                                    <input type="text" class="configKey form-control" data-l1key="cronSleepTime"/>
                                </div>
                            </div>
                            <div class="form-group alert alert-danger">
                                <label class="col-md-2 control-label">{{Deamons sleep time}}</label>
                                <div class="col-md-3">
            ...
            <div id="configuration_logMessage" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Ajouter un message à chaque erreur dans les logs}}</label>
                                <div class="col-md-1">
                                    <input type="checkbox" class="configKey" data-l1key="addMessageForErrorLog" checked/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Nombre de lignes maximum dans un fichier de log}}</label>
                                <div class="col-md-3">
                                    <input type="text" class="configKey form-control" data-l1key="maxLineLog"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Logs actifs}}</label>
                                <div class="col-md-2">
                                    <div class="checkbox">
                                        <label>
            ...
            <div id="config_ldap" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Activer l'authentification LDAP}}</label>
                                <div class="col-md-1">
                                    <input type="checkbox" class="configKey" data-l1key="ldap:enable"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Hôte}}</label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Filtre (optionnel)}}</label>
                                <div class="col-md-3">
            ...
            <div id="configuration_commandeEqlogic" class="panel-collapse collapse">
                <div class="panel-body">
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-2 control-label">{{Nombre d'échec avant désactivation de l'équipement}}</label>
                                <div class="col-md-3">
                ...
                <div id="configuration_nodeJS" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="form-group expertModeVisible">
                                    <label class="col-md-2 control-label">{{Activer NodeJS}}</label>
                                    <div class="col-md-1">
                                        <input type="checkbox" class="configKey" data-l1key="enableNodeJs"/>
                                    </div>
                                </div>
                                <div class="form-group expertModeVisible">
                                    <label class="col-md-2 control-label">{{Port interne NodeJS}}</label>
                                    <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">{{Installer automatiquement les widgets manquants}}</label>
                                    <div class="col-md-3">
                                        <input type="checkbox"  class="configKey" data-l1key="market::autoInstallMissingWidget" />
                                    </div>
                                </div>
                                <div class="form-group alert alert-danger">
                                    <label class="col-md-2 control-label">{{Voir modules non validés (à vos risques et périls)}}</label>
                                    <div class="col-md-3">
                ...
                <div id="configuration_update" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="form-group expertModeVisible">
                                    <label class="col-md-2 control-label">{{Faire une sauvegarde avant la mise à jour}}</label>
                                    <div class="col-md-1">
                                        <input type="checkbox" class="configKey" data-l1key="update::backupBefore"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">{{Branche}}</label>
                                    <div class="col-md-2">
