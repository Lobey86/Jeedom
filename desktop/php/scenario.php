...
<div class="row row-overflow">
        ...
        <div class="bs-sidebar">
            <ul id="ul_scenario" class="nav nav-list bs-sidenav">                  
                ...
                if (config::byKey('enableScenario') == 0) {
                    echo '<a class="btn btn-sm btn-default expertModeVisible" id="bt_changeAllScenarioState" data-state="1" style="display: inline-block;" title="{{Activer le système de scénario}}"><i class="fa fa-check" style="color : green;font-size : 1.5em;"></i> {{Activat. scénarios}}</a>';
                } else {
                    echo '<a class="btn btn-sm btn-default expertModeVisible" id="bt_changeAllScenarioState" data-state="0" style="display: inline-block;" title="{{Desactiver le système de scénario}}"><i class="fa fa-times" style="color : red;font-size : 1.5em;"></i> {{Désactiv. scénarios}}</a>';
                }
                ?>
                <a class="btn btn-default btn-sm tooltips expertModeVisible" id="bt_displayScenarioVariable" title="{{Voir toutes les variables de scénario}}" style="display: inline-block;"><i class="fa fa fa-eye" style="font-size : 1.5em;"></i> {{Voir variables}}</a>
    ...
    <div class="col-sm-10" id="div_editScenario" style="display: none; border-left: solid 1px #EEE; padding-left: 25px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >{{Mode du scénario}}</label>
                        <div class="col-sm-3">
                    ...
                    <div class="scheduleDisplay" style="display: none;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label" >{{Précédent}}</label>
                            <div class="col-sm-3" ><span class="scenarioAttr label label-primary" data-l1key="forecast" data-l2key="prevDate" data-l3key="date"></span></div>
                            <label class="col-sm-3 control-label" >{{Prochain}}</label>
                            <div class="col-sm-3"><span class="scenarioAttr label label-success" data-l1key="forecast" data-l2key="nextDate" data-l3key="date"></span></div> 
                        </div>
            ...
            <div class="col-sm-3">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-6 control-label" for="span_lastCheck">{{Dernier lancement}}</label>
                        <div class="col-sm-6">
                            <div><span id="span_lastLaunch" class="label label-info" style="position: relative; top: 4px;"></span></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-6 control-label" for="span_ongoing">{{Etat}}</label>
                        <div class="col-sm-6">
