...
<div class="row row-overflow">
    ...
    <div class="col-md-10 object" style="display: none;" id="div_conf">
        <form class="form-horizontal">
            <fieldset>
                <legend>{{Général}}</legend>
                <div class="form-group">
                    <label class="col-md-1 control-label">{{Nom de l'objet}}</label>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <label class="col-md-1 control-label">{{Père}}</label>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <label class="col-md-1 control-label">{{Visible}}</label>
                    <div class="col-md-1">
                        <input class="objectAttr" type="checkbox"  data-l1key="isVisible" checked/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-1 control-label">{{Icône}}</label>
                    <div class="col-md-2">
