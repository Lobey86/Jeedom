...
<form class="form-horizontal" role="form" id="form_reportBug">
    <div class='alert alert-info'>
        Attention lors de l'envoi d'un rapport de bug, tous les logs sont automatiquement envoyé en même temps. Cepandant ces logs ne seront accessible que par vous ou l'équipe de support.
    </div>
