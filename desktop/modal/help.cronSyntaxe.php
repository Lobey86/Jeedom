...
<dl>
    ...
    <dd>Remarque: Point d'interrogation est un personnage atypique et n'existe que dans certaines implémentations de cron. Il est utilisé à la place de '*' pour quitter soit vierge jour de mois ou le jour de la semaine.</dd>
</dl>