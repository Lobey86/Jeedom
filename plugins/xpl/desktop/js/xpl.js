...
function addCmdToTable(_cmd) {
    ...
    var selxPlschema = '<select class="cmdAttr form-control" data-l1key="configuration" data-l2key="xPLschema" style="width : 150px;">';
    selxPlschema += '<option value="control.basic">Control.basic</option>';
    selxPlschema += '<option value="sensor.basic">Sensor.basic</option>';
    selxPlschema += '</select>';

    var typeXmdxPL = '<select class="cmdAttr form-control" data-l1key="configuration" data-l2key="xPLtypeCmd" style="width : 150px;margin-top : 5px;">';
    ...
    tr += '<td class="xPLbody">';
    tr += '<textarea style="height : 100px;" class="cmdAttr form-control" data-l1key="configuration" data-l2key="xPLbody">' + init(_cmd.configuration.xPLbody) + '</textarea>';
    tr += '</td>';
    tr += '<td>';
    ...
    tr += '<span><input type="checkbox" class="cmdAttr" data-l1key="eventOnly" /> Evénement seulement<br/></span>';
    tr += '<span><input type="checkbox" class="cmdAttr" data-l1key="cache" data-l2key="enable" checked /> Autoriser cache</span>';
    tr += '</td>';
    ...
    $('#table_cmd tbody tr:last .cmdAttr[data-l1key=configuration][data-l2key=xPLschema]').trigger('change');
}
