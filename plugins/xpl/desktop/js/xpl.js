...
function addCmdToTable(_cmd) {
    ...
    tr += '<td class="xPLbody">';
    tr += '<textarea style="height : 100px;" class="cmdAttr form-control input-sm" data-l1key="configuration" data-l2key="xPLbody">' + init(_cmd.configuration.xPLbody) + '</textarea>';
    tr += '</td>';
    tr += '<td>';
