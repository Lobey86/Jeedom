...
<div class="form-group cmd" mode="!" type="d" value="1">
    ...
    <input type="text" class="cmdAttr form-control" l1key="configuration" l2key="value" value="1" style="display: none;"/>

    <label class="col-lg-2 control-label" >Nom écriture "1"</label>
    <div class="col-lg-2">
        <input type="text" class="cmdAttr form-control" l1key="name" value="On"/>
    </div>
</div>
<div class="form-group cmd" type="!" mode="d" value="1">
    <input type="text" class="cmdAttr form-control" l1key="id" value="" style="display: none;"/>
    <input type="text" class="cmdAttr form-control" l1key="eventOnly" value="0" style="display: none;"/>
    <input type="text" class="cmdAttr form-control" l1key="unite" value="" style="display: none;"/>
    <input type="text" class="cmdAttr form-control" l1key="isHistorized" value="0" style="display: none;"/>
    ...
    <input type="text" class="cmdAttr form-control" l1key="configuration" l2key="mode" value="!" style="display: none;"/>
    <input type="text" class="cmdAttr form-control" l1key="configuration" l2key="type" value="d" style="display: none;"/>
    <input type="text" class="cmdAttr form-control" l1key="configuration" l2key="value" value="0" style="display: none;"/>

    <label class="col-lg-2 control-label" >Nom écriture "0"</label>
    <div class="col-lg-2">
        <input type="text" class="cmdAttr form-control" l1key="name" value="Off"/>
    </div>
</div>