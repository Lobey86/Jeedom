(function($) {
		...
		return this.each(function() {
			...
			mouseover = function(e) {
				...
				if(
					...
					/*
					small change by PoltoS to adopt this module to our purpose
					&&
			...
			if(options.alwaysOn) {
				...
				$(map).find('area[coords]')
					.mouseover(function(event){
						if (!options.mouseoverDisable.call(this,event)) {
						...
						if (!options.mouseoutDisable.call(this,event)) {
							clear_canvas(canvas);
	...
	$.fn.maphilight.defaults = {
		...
		groupBy: false,
		wrapClass: true,
		mouseoverDisable: function(){return false;},
		mouseoutDisable: function(){return false;}
	};
})(jQuery);
