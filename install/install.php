...
try {
    ...
    echo "***************Installation/Mise à jour de Jeedom " . $JEEDOM_VERSION . "***************\n";
    $update = false;
    ...
    if ($update) {
        ...
        if (version_compare($JEEDOM_VERSION, $curentVersion, '=') && !isset($_GET['v'])) {
            echo "Jeedom est installé et en dernière version : " . $JEEDOM_VERSION . "\n";
            startActivities();
        ...
        if (isset($_GET['v'])) {
            ...
            while (version_compare($JEEDOM_VERSION, $curentVersion, '>')) {
        ...
        echo "\nInstallation de Jeedom " . $JEEDOM_VERSION . "\n";
    ...
    config::save('version', $JEEDOM_VERSION);
} catch (Exception $e) {
    startActivities();
